...
public class SustainableTripService {
    ...
    public SustainableTrip createTrip(String userName, String origin, String destination, String preference) {
        SustainableTrip trip = new SustainableTrip(userName, origin, destination, preference);
