                        ...
                        <div class="card trip-card">
                            <div class="trip-card-header d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <small class="text-muted"><fmt:formatDate value="${trip.completedAt}" pattern="MMM dd, yyyy h:mm a" /></small>
                                </div>
                                ...
                                <div class="trip-metrics">
                                    <c:forEach var="option" items="${trip.travelOptions}">
                                        <c:if test="${option.selected}">
                                            ...
                                            <div class="metric">
                                                <i class="fas fa-dollar-sign me-1"></i> <strong>$<fmt:formatNumber value="${option.actualCost}" pattern="#,##0.00" /></strong>
                                            </div>
